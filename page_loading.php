...
if($page== 'home'){
    echo '<div id="skeletonpage">'. PT_LoadPage("skeleton/home",array()).'</div>';
}
if($page== 'watch'){
    echo '<div id="skeletonpage">'. PT_LoadPage("skeleton/watch",array()).'</div>';
}
if($page== 'channel'){
    echo '<div id="skeletonpage">'. PT_LoadPage("skeleton/channel",array()).'</div>';
}
if($page== 'search'){
    echo '<div id="skeletonpage">'. PT_LoadPage("skeleton/search",array()).'</div>';
}else{
    echo '<div id="skeletonpage"> </div>';
...
if (IS_LOGGED) {
    ...
    $require_pages = array('sign-in','confirm','contact','embed','forgot_password','register','404','logout','resend','reset-password','terms');
...
if (file_exists("./sources/$page/content.php")) {
    ...
    document.getElementById("skeletonpage").innerHTML = "";
    </script>';
}
