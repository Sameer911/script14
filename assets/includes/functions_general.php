...
function PT_LoadPage($page_url = '', $data = array(), $set_lang = true) {
    ...
    $page = './pages/' . $config['theme'] . '/layout/' . $page_url . '.html';
    if (!file_exists($page)) {
...
function pt_custom_design($a = false,$code = array()){
    ...
    $data        = array();
    $custom_code = array(
        "pages/$theme/js/header.js",
        "pages/$theme/js/footer.js",
        "pages/$theme/css/custom.style.css",
    );
