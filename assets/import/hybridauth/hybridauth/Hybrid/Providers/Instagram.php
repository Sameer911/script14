...
*/
class Hybrid_Providers_Instagram extends Hybrid_Provider_Model
{ 
    ...
    public $scope = ['instagram_basic','pages_show_list','email', 'user_about_me', 'user_birthday', 'user_hometown', 'user_location', 'user_website', 'publish_actions', 'read_custom_friendlists'];
